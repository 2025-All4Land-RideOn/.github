...
| 등고선·음영기복도 레이어 | DEM 기반 등고선 및 음영기복도를 지도 레이어로 제공하여 지형의 고저 차이를 시각화 |
| 지도 레이어 전환 | OSM·Mapbox·VWorld 등 지도 레이어 간 전환 기능 |
...
| 좌표계 패널 시각화 | 좌표계, 줌 레벨, 지도 영역의 좌표·범위 정보 실시간 확인 기능 |
| AI 문의 기능 ‘라온이’ | 사용자의 질문에 대해 서비스 이용 및 기능 안내를 LLM 기반으로 자동 응답 |
